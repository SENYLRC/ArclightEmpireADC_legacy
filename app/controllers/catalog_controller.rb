...
# SENYLRC Collection Show Page - Indexed Terms Section
    config.add_indexed_terms_field 'genreform_sim', label: 'Format', link_to_facet: true, separator_options: {
      words_connector: '<br/>',
      two_words_connector: '<br/>',
      last_word_connector: '<br/>'
    }
    ...
    config.add_component_indexed_terms_field 'genreform_sim', label: 'Format', link_to_facet: true, separator_options: {
      words_connector: '<br/>',
      two_words_connector: '<br/>',
      last_word_connector: '<br/>'
    }
